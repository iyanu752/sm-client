...
const { iterator, toStringTag: toStringTag$2 } = Symbol;
...
const isPlainObject = (val) => {
  ...
  return (prototype2 === null || prototype2 === Object.prototype || Object.getPrototypeOf(prototype2) === null) && !(toStringTag$2 in val) && !(iterator in val);
};
...
function isSpecCompliantForm(thing) {
  return !!(thing && isFunction$2(thing.append) && thing[toStringTag$2] === "FormData" && thing[iterator]);
}
...
var Stream$5 = stream.Stream;
var util$5 = require$$1;
var delayed_stream$1 = DelayedStream$3;
function DelayedStream$3() {
  this.source = null;
  this.dataSize = 0;
...
util$5.inherits(DelayedStream$3, Stream$5);
DelayedStream$3.create = function(source, options) {
...
Object.defineProperty(DelayedStream$3.prototype, "readable", {
  configurable: true,
  enumerable: true,
  get: function() {
...
DelayedStream$3.prototype.setEncoding = function() {
  return this.source.setEncoding.apply(this.source, arguments);
};
DelayedStream$3.prototype.resume = function() {
  if (!this._released) {
    this.release();
  }
  this.source.resume();
};
DelayedStream$3.prototype.pause = function() {
  this.source.pause();
};
DelayedStream$3.prototype.release = function() {
  this._released = true;
...
DelayedStream$3.prototype.pipe = function() {
  var r = Stream$5.prototype.pipe.apply(this, arguments);
  this.resume();
  return r;
};
DelayedStream$3.prototype._handleEmit = function(args) {
  if (this._released) {
    this.emit.apply(this, args);
    return;
  }
...
DelayedStream$3.prototype._checkIfMaxDataSizeExceeded = function() {
...
var Stream$4 = stream.Stream;
var DelayedStream$2 = delayed_stream$1;
var combined_stream$1 = CombinedStream$3;
function CombinedStream$3() {
  this.writable = false;
  this.readable = true;
  this.dataSize = 0;
...
util$4.inherits(CombinedStream$3, Stream$4);
CombinedStream$3.create = function(options) {
...
CombinedStream$3.isStreamLike = function(stream2) {
...
CombinedStream$3.prototype.append = function(stream2) {
  var isStreamLike = CombinedStream$3.isStreamLike(stream2);
  if (isStreamLike) {
    if (!(stream2 instanceof DelayedStream$2)) {
      var newStream = DelayedStream$2.create(stream2, {
...
CombinedStream$3.prototype.pipe = function(dest, options) {
  Stream$4.prototype.pipe.call(this, dest, options);
  this.resume();
  return dest;
};
CombinedStream$3.prototype._getNext = function() {
  this._currentStream = null;
  if (this._insideLoop) {
...
CombinedStream$3.prototype._realGetNext = function() {
  ...
  getStream((function(stream3) {
    var isStreamLike = CombinedStream$3.isStreamLike(stream3);
    if (isStreamLike) {
...
CombinedStream$3.prototype._pipeNext = function(stream2) {
...
CombinedStream$3.prototype._handleErrors = function(stream2) {
  var self2 = this;
  stream2.on("error", function(err) {
    self2._emitError(err);
  });
};
CombinedStream$3.prototype.write = function(data) {
  this.emit("data", data);
};
CombinedStream$3.prototype.pause = function() {
  if (!this.pauseStreams) {
    return;
  }
...
CombinedStream$3.prototype.resume = function() {
  if (!this._released) {
    this._released = true;
    this.writable = true;
    this._getNext();
...
CombinedStream$3.prototype.end = function() {
  this._reset();
  this.emit("end");
};
CombinedStream$3.prototype.destroy = function() {
  this._reset();
  this.emit("close");
};
CombinedStream$3.prototype._reset = function() {
  this.writable = false;
  this._streams = [];
  this._currentStream = null;
};
CombinedStream$3.prototype._checkDataSize = function() {
...
CombinedStream$3.prototype._updateDataSize = function() {
  this.dataSize = 0;
  var self2 = this;
...
CombinedStream$3.prototype._emitError = function(err) {
  this._reset();
  this.emit("error", err);
};
var mimeTypes$1 = {};
...
var defer$2 = defer_1$1;
var async_1$1 = async$5;
function async$5(callback) {
  var isAsync = false;
  defer$2(function() {
    isAsync = true;
  });
...
var abort_1$1 = abort$5;
function abort$5(state2) {
  Object.keys(state2.jobs).forEach(clean$1.bind(state2));
  state2.jobs = {};
}
function clean$1(key) {
  if (typeof this.jobs[key] == "function") {
    this.jobs[key]();
  }
}
var async$4 = async_1$1, abort$4 = abort_1$1;
var iterate_1$1 = iterate$5;
function iterate$5(list, iterator2, state2, callback) {
  var key = state2["keyedList"] ? state2["keyedList"][state2.index] : state2.index;
  state2.jobs[key] = runJob$1(iterator2, key, list[key], function(error, output) {
...
function runJob$1(iterator2, key, item, callback) {
  var aborter;
  if (iterator2.length == 2) {
    aborter = iterator2(item, async$4(callback));
  } else {
    aborter = iterator2(item, key, async$4(callback));
  }
  return aborter;
}
var state_1$1 = state$1;
...
var abort$3 = abort_1$1, async$3 = async_1$1;
var terminator_1$1 = terminator$5;
function terminator$5(callback) {
  if (!Object.keys(this.jobs).length) {
    return;
  }
  this.index = this.size;
  abort$3(this);
  async$3(callback)(null, this.results);
}
var iterate$4 = iterate_1$1, initState$3 = state_1$1, terminator$4 = terminator_1$1;
var parallel_1$1 = parallel$1;
function parallel$1(list, iterator2, callback) {
  var state2 = initState$3(list);
  while (state2.index < (state2["keyedList"] || list).length) {
    iterate$4(list, iterator2, state2, function(error, result) {
      if (error) {
  ...
  return terminator$4.bind(state2, callback);
}
var serialOrdered$5 = { exports: {} };
var iterate$3 = iterate_1$1, initState$2 = state_1$1, terminator$3 = terminator_1$1;
serialOrdered$5.exports = serialOrdered$4;
serialOrdered$5.exports.ascending = ascending$1;
serialOrdered$5.exports.descending = descending$1;
function serialOrdered$4(list, iterator2, sortMethod, callback) {
  var state2 = initState$2(list, sortMethod);
  iterate$3(list, iterator2, state2, function iteratorHandler(error, result) {
    if (error) {
      callback(error, result);
      return;
    }
    ...
    if (state2.index < (state2["keyedList"] || list).length) {
      iterate$3(list, iterator2, state2, iteratorHandler);
      return;
    }
    callback(null, state2.results);
  });
  return terminator$3.bind(state2, callback);
}
function ascending$1(a, b) {
  return a < b ? -1 : a > b ? 1 : 0;
}
function descending$1(a, b) {
  return -1 * ascending$1(a, b);
}
var serialOrderedExports$1 = serialOrdered$5.exports;
var serialOrdered$3 = serialOrderedExports$1;
var serial_1$1 = serial$1;
function serial$1(list, iterator2, callback) {
  return serialOrdered$3(list, iterator2, null, callback);
}
var asynckit$3 = {
  parallel: parallel_1$1,
  serial: serial_1$1,
  serialOrdered: serialOrderedExports$1
};
var esObjectAtoms$1 = Object;
var esErrors$1 = Error;
var _eval$1 = EvalError;
...
var _isNaN$1 = Number.isNaN || function isNaN2(a) {
  return a !== a;
};
var $isNaN$1 = _isNaN$1;
...
var gopd$1 = $gOPD$3;
var $defineProperty$5 = Object.defineProperty || false;
if ($defineProperty$5) {
  try {
    $defineProperty$5({}, "a", { value: 1 });
  } catch (e) {
    $defineProperty$5 = false;
  }
}
var esDefineProperty$1 = $defineProperty$5;
var shams$3;
var hasRequiredShams$3;
function requireShams$3() {
  if (hasRequiredShams$3) return shams$3;
  hasRequiredShams$3 = 1;
  shams$3 = function hasSymbols2() {
...
function requireHasSymbols$1() {
  if (hasRequiredHasSymbols$1) return hasSymbols$3;
...
function requireObject_getPrototypeOf$1() {
  ...
  var $Object2 = esObjectAtoms$1;
  Object_getPrototypeOf$1 = $Object2.getPrototypeOf || null;
...
function requireActualApply$1() {
  ...
  var $apply2 = requireFunctionApply$1();
  var $call2 = requireFunctionCall$1();
  var $reflectApply = requireReflectApply$1();
  actualApply$1 = $reflectApply || bind4.call($call2, $apply2);
...
function requireCallBindApplyHelpers$1() {
  ...
  callBindApplyHelpers$1 = function callBindBasic(args) {
    ...
    return $actualApply(bind4, $call2, args);
  };
...
function requireGetProto$1() {
  if (hasRequiredGetProto$1) return getProto$3;
...
var hasown$1 = bind$3.call(call$1, $hasOwn$1);
var undefined$2;
var $Object$1 = esObjectAtoms$1;
var $Error$1 = esErrors$1;
var $EvalError$1 = _eval$1;
...
var $gOPD$2 = gopd$1;
var $defineProperty$4 = esDefineProperty$1;
...
var hasSymbols$2 = requireHasSymbols$1()();
var getProto$2 = requireGetProto$1();
var $ObjectGPO$1 = requireObject_getPrototypeOf$1();
var $ReflectGPO$1 = requireReflect_getPrototypeOf$1();
var $apply$1 = requireFunctionApply$1();
var $call$1 = requireFunctionCall$1();
var needsEval$1 = {};
...
var INTRINSICS$1 = {
  ...
  "%Float16Array%": typeof Float16Array === "undefined" ? undefined$2 : Float16Array,
  ...
  "%Object.defineProperty%": $defineProperty$4,
...
var hasOwn$5 = hasown$1;
var $concat$1 = bind$2.call($call$1, Array.prototype.concat);
var $spliceApply$1 = bind$2.call($apply$1, Array.prototype.splice);
var $replace$1 = bind$2.call($call$1, String.prototype.replace);
var $strSlice$1 = bind$2.call($call$1, String.prototype.slice);
var $exec$1 = bind$2.call($call$1, RegExp.prototype.exec);
...
var getBaseIntrinsic$1 = function getBaseIntrinsic(name, allowMissing) {
  ...
  var alias;
  if (hasOwn$5(LEGACY_ALIASES$1, intrinsicName)) {
    alias = LEGACY_ALIASES$1[intrinsicName];
    intrinsicName = "%" + alias[0] + "%";
  }
  if (hasOwn$5(INTRINSICS$1, intrinsicName)) {
...
var getIntrinsic$1 = function GetIntrinsic(name, allowMissing) {
  ...
  for (var i = 1, isOwn = true; i < parts.length; i += 1) {
    ...
    if (hasOwn$5(INTRINSICS$1, intrinsicRealName)) {
...
function requireShams$2() {
  ...
  var hasSymbols2 = requireShams$3();
...
var esSetTostringtag$1 = function setToStringTag(object, value) {
  ...
  if (toStringTag$1 && (overrideIfSet || !hasOwn$4(object, toStringTag$1))) {
    if ($defineProperty$3) {
      $defineProperty$3(object, toStringTag$1, {
...
function FormData$3(options) {
  ...
  CombinedStream$2.call(this);
  options = options || {};
  for (var option in options) {
    this[option] = options[option];
  }
}
util$3.inherits(FormData$3, CombinedStream$2);
...
FormData$3.prototype.append = function(field, value, options) {
  ...
  var append2 = CombinedStream$2.prototype.append.bind(this);
...
FormData$3.prototype._trackLength = function(header, value, options) {
  ...
  if (!value || !value.path && !(value.readable && hasOwn$3(value, "httpVersion")) && !(value instanceof Stream$3)) {
    return;
  }
...
FormData$3.prototype._lengthRetriever = function(value, callback) {
  ...
  } else if (hasOwn$3(value, "httpVersion")) {
    callback(null, Number(value.headers["content-length"]));
  } else if (hasOwn$3(value, "httpModule")) {
...
FormData$3.prototype._getContentDisposition = function(value, options) {
  ...
  } else if (value && value.readable && hasOwn$3(value, "httpVersion")) {
...
FormData$3.prototype._getContentType = function(value, options) {
  ...
  if (!contentType && value && value.readable && hasOwn$3(value, "httpVersion")) {
...
FormData$3.prototype.getHeaders = function(userHeaders) {
  ...
  for (header in userHeaders) {
    if (hasOwn$3(userHeaders, header)) {
...
FormData$3.prototype.getLength = function(cb) {
  ...
  asynckit$2.parallel(this._valuesToMeasure, this._lengthRetriever, function(err, values) {
    if (err) {
      cb(err);
      return;
    }
...
FormData$3.prototype.submit = function(params, cb) {
  ...
  if (typeof params === "string") {
    ...
    options = populate$2(params, defaults2);
    if (!options.port) {
...
setToStringTag$1(FormData$3, "FormData");
var form_data$1 = FormData$3;
const FormData$4 = /* @__PURE__ */ getDefaultExportFromCjs(form_data$1);
...
function getProxyForUrl(url2) {
  var parsedUrl = typeof url2 === "string" ? parseUrl$2(url2) : url2 || {};
...
function resolveUrl(relative, base) {
  return useNativeURL ? new URL$1(relative, base) : parseUrl$1(url.resolve(base, relative));
}
...
var _isNaN = Number.isNaN || function isNaN3(a) {
  return a !== a;
};
var $isNaN = _isNaN;
...
var concatty2 = function concatty3(a, b) {
  var arr = [];
  for (var i = 0; i < a.length; i += 1) {
    arr[i] = a[i];
  }
...
var slicy2 = function slicy3(arrLike, offset) {
  var arr = [];
  for (var i = offset, j = 0; i < arrLike.length; i += 1, j += 1) {
    arr[j] = arrLike[i];
  }
...
var implementation$1 = function bind2(that) {
  ...
  var args = slicy2(arguments, 1);
  var bound;
  var binder = function() {
    if (this instanceof bound) {
      var result = target.apply(
        this,
        concatty2(args, arguments)
      );
      if (Object(result) === result) {
        return result;
      }
...
function requireActualApply() {
  ...
  actualApply = $reflectApply || bind4.call($call2, $apply2);
  return actualApply;
}
...
var setToStringTag3 = esSetTostringtag;
var hasOwn = hasown;
...
setToStringTag3(FormData$1, "FormData");
...
electron.contextBridge.exposeInMainWorld("ipcRenderer", {
  ...
  analyzeImage: async (filePath) => {
    ...
    formData.append("image", require$$6.createReadStream(filePath));
  ...
  transcribeAudio: async (filePath) => {
    const formData = new FormData$2();
    formData.append("audio", require$$6.createReadStream(filePath));
